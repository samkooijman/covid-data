This document describes the contents of the weather per region in United Kingdom (UK). The variable names described below refer to column names. The data is fetched by using an API of WorldWeatherOnline. This API is free for 60 days and limited to 500 calls per day. 
