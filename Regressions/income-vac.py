...
begin = uk_income['date'].iloc[1]
end = uk_income['date'].iloc[-1]
...
def graph(date):
    ...
    scatterplot1.add_trace(go.Scatter (x=dff1['income'], y= dff1["coef"] * dff1["income"] + dff1["intersect"], mode="lines"))
    ...
    scatterplot2.add_trace(go.Scatter (x=dff2['income'], y= dff2["coef"] * dff2["income"] + dff2["intersect"], mode="lines"))
    ...
    scatterplot3.add_trace(go.Scatter (x=dff3['income'], y= dff3["coef"] * dff3["income"] + dff3["intersect"], mode="lines"))
